...
public:
  SK::GlImage *midimage;
private:
  inline void cb_midimage_i(SK::GlImage*, void*);
  static void cb_midimage(SK::GlImage*, void*);
public:
  Fl_Input *chat;
private:
...
private:
  inline void cb_server_i(Fl_Check_Button*, void*);
  static void cb_server(Fl_Check_Button*, void*);
public:
  Fl_Input *name;
private:
