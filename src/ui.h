...
public:
				fltk::Input *chat;
private:
				inline void cb_chat_i(fltk::Input*, void*);
				static void cb_chat(fltk::Input*, void*);
...
public:
					fltk::Button *bgcolor;
private:
					inline void cb_bgcolor_i(fltk::Button*, void*);
					static void cb_bgcolor(fltk::Button*, void*);
public:
