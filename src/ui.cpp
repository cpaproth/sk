...
static Fl_Image *image_diamonds() {
  static Fl_Image *image = new Fl_Pixmap(idata_diamonds);
  return image;
}
...
static Fl_Image *image_hearts() {
  static Fl_Image *image = new Fl_Pixmap(idata_hearts);
  return image;
}
...
static Fl_Image *image_spades() {
  static Fl_Image *image = new Fl_Pixmap(idata_spades);
  return image;
}
...
static Fl_Image *image_clubs() {
  static Fl_Image *image = new Fl_Pixmap(idata_clubs);
  return image;
}
